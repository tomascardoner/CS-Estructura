    ...
    Friend Sub SetDataFromObjectToControls()
        ...
        Else
            With mObjetoActual
                ...
                CardonerSistemas.ComboBox.SetSelectedValue(comboboxClase, CardonerSistemas.ComboBox.SelectedItemOptions.ValueOrFirst, mObjetoActual.IDClase)
    ...
    Private Sub Eliminar_Click() Handles buttonEliminar.Click
        ...
        Else
            ...
            If MsgBox("Se eliminará el Objeto seleccionado." & vbCrLf & vbCrLf & ObjetoActual.Nombre & vbCrLf & vbCrLf & "¿Confirma la eliminación definitiva?", CType(MsgBoxStyle.Exclamation + MsgBoxStyle.YesNo, MsgBoxStyle), My.Application.Info.Title) = MsgBoxResult.Yes Then
                ...
                Catch ex As Exception
                    CardonerSistemas.ErrorHandler.ProcessError(ex, "Error al eliminar el Objeto.")
                End Try
