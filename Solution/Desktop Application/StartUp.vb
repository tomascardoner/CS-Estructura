Module StartUp
    ...
    Friend Sub Main()
        ...
        pDatabase.AttachDBFilename = My.Settings.DBConnection_AttachDBFilename
        ...
        Dim Decrypter As New CS_Encrypt_TripleDES(CS_Constants.PUBLIC_ENCRYPTION_PASSWORD)
        Dim DecryptedText As String = ""
        If Decrypter.Decrypt(My.Settings.DBConnection_Password, DecryptedText) Then
        ...
        CSEstructuraContext.CreateConnectionString(My.Settings.DBConnection_Provider, pDatabase.ConnectionString)
